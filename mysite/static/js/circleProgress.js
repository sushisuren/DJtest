(function (window) {
    ...
    var circleProgress = function (options) {
        ...
        options.color = options.color || 'rgb(255, 255, 255)';
        options.bgColor = options.bgColor || 'rgb(100, 190, 255)';
        options.textColor = options.textColor || 'white';
        options.progressWidth = options.progressWidth || 0.1; //r
        options.fontScale = options.fontScale || 0.6; //r

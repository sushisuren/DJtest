(function ($) {
    $.querycity = function (input, options) {
        ...
        $('.data-city').append("<div id='pop_city_" + input.attr('id') + "' class='pop_city' style='display:none'><p class='pop_head'></p><ul class='list_label'></ul><div class='pop_city_container'></div></div>");
        $('.data-city').append("<div id='suggest_city_" + input.attr('id') + "' class='list_city' style='display:none'><div class='list_city_head'></div><div class='list_city_container'></div><div class='page_break'></div></div>");
        ...
        }).on('mouseout', '.list_city_container a',function () {
            t_suggest_focus = false;
        });
        suggestMain.on('mouseover','.page_break a', function () {
            t_suggest_focus = true;
        }).on('mouseout','.page_break a', function () {
            t_suggest_focus = false;
        });
        ...
        function resetPosition() {
            popMain.css({'top': $('.data-city').innerHeight(), 'left':'0px' });
            suggestMain.css({'top': $('.data-city').innerHeight(), 'left':'0px'});
        }
    }

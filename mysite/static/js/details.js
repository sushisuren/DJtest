...
//日历的勾选框
$(".date_list ul .have").click(function(){
...
//楼层导航
	...
	$(window).scroll(function(){
		...
		var _hei=$(".tou").height()+$(".black2").height();
		//天数的距离
		var _andate=$(".tou").height()+$(".black2").height()+$(".black3").height()+$(".tab_detail").height()+$(".black5").height();
		var _andate2=$(".tou").height()+$(".black2").height()+$(".black3").height()+$(".tab_detail").height()+$(".black5").height()+$(".travelctrip").height();
		//产品信息的距离
